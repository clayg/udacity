...
def makeTerrainData(n_points=1000):
    ...
    # grade_sig = [X_train[ii][0] for ii in range(0, len(X_train))
    #              if y_train[ii] == 0]
    # bumpy_sig = [X_train[ii][1] for ii in range(0, len(X_train))
    #              if y_train[ii] == 0]
    # grade_bkg = [X_train[ii][0] for ii in range(0, len(X_train))
    #              if y_train[ii] == 1]
    # bumpy_bkg = [X_train[ii][1] for ii in range(0, len(X_train))
    #              if y_train[ii] == 1]
